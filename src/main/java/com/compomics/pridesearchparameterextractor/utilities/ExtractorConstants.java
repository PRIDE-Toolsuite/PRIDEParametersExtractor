 ...
 * ==Overview==
 * <p>
 * This class define a set of constants that would be use on all the search parameters. In the reanalysis pipeline we will use some
 * default parameters that are better that the one we can estimate.
 * <p>
